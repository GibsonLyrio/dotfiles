...
globalkeys = gears.table.join(
    ...
    -- Lock screen
    awful.key({ modkey, "Control" }, "l",     function() awful.spawn.with_shell("~/.lock.sh") end,
                 {description = "Lock screen", group = "Added - custom"}),
    --- Volume controler
...
awful.rules.rules = {
    ...
    { rule = { class = "Polybar" },
      properties = { border_width = 0  -- Disable the border
     }
    },
    -- Floating clients.
    { rule_any = {
